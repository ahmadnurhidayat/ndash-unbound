...
NDash Unbound sekarang berfungsi sebagai **full DNS resolver** yang dapat:
1. ✅ Resolve domain internet (google.com, cloudflare.com, etc.)
2. ✅ Resolve local zones yang dikelola NDash (dionipe.id, etc.)
3. ✅ Cache DNS queries untuk performance
4. ✅ Forward ke DNS public (Cloudflare & Google DNS)
...
Clients di jaringan lokal dapat menggunakan server ini sebagai DNS resolver.
...
✅ **Unbound sekarang berfungsi sebagai:**
- **Recursive DNS Resolver** untuk internet domains
- **Authoritative Server** untuk local zones (NDash managed)
- **DNS Cache** untuk improved performance
- **DNS Forwarder** ke Cloudflare & Google DNS
